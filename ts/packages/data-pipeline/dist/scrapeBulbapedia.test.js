...
describe("scrapeBulbapedia", () => {
    ...
    describe("scrapeBulbapediaCard", () => {
      ...
      `;
        ...
        it("should throw if card name is missing", () => {
            ...
            expect(() => scrapeBulbapediaCard(html, "unknown")).toThrow("Could not parse card name");
        });
    });
    describe("scrapeBulbapediaCards", () => {
        ...
        it("should log progress for each card", async () => {
            ...
            expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining("[1/2] Scraping Card1..."));
            expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining("[2/2] Scraping Card2..."));
...
//# sourceMappingURL=scrapeBulbapedia.test.js.map